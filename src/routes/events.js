        ...
        payment.save().then(result => {
            ...
            Events.findOne({_id: req.params.id}).then((result) => {
                ...
                let mailOptions = {
                    from: '',
                    to: req.body.email,
                    subject: 'Booking Confirmed - Unviversity Of ............',
                    html: `<h2>Hello!</h2>
...
router.post('/sendPPAlerts/:id', (req,res) => {
    ...
    ticket.find().then(result =>{
        ...
        let mailOptions = {
            from: '',
            to: result[i].email,
            subject: `Event ${resulte.title} Postponed - Unviversity Of .... Event Protal`,
            html: `<h2>Hello!</h2>
        <br>
        <p>${req.body.datas}</p>
        <br>
...
router.post('/sendReminderAlerts/:id', (req,res) => {
    ...
    ticket.find().then(result =>{
        ...
        let mailOptions = {
            from: '',
            to: result[i].email,
            subject: `Event Reminder For ${resulte.title} - Unviversity Of ....... Event Protal`,
            html: `<h2>Hello!</h2>
        <br>
        <p>${req.body.datas}</p>
        <br>
