...
router.post('/sendAlerts/:id', (req,res) => {
  ...
  album.findOne({_id: req.params.id}).then(results => {
      ...
      let mailOptions = {
          from: '',
          to: '',
          subject: `${results.name} Album Approved - Unviversity Of ........ Event Protal`,
          html: `<h2>Hello!</h2>
      <br>
      <p>Your album has been approved. Please visit to ..... event protal and start to upload images.</p>
      <br>
      <p>Thank You,</p>
      <p>Regards,</p>
      <p>Admin</p> `
